...
it('multiSign() for x-of-5 should be deterministic', function () {
  ...
  var tx0Serialized = zencashjs.transaction.serializeTx(tx0)

  var txObjSig1 = zencashjs.transaction.applyMultiSignatures(txobj, 0, [sig1], redeemScript)
  var tx1 = zencashjs.transaction.applyMultiSignatures(txObjSig1, 0, [sig2], redeemScript)
  var tx1Serialized = zencashjs.transaction.serializeTx(tx1)

  var txObjSig2 = zencashjs.transaction.applyMultiSignatures(txobj, 0, [sig2], redeemScript)
  var tx2 = zencashjs.transaction.applyMultiSignatures(txObjSig2, 0, [sig1], redeemScript)
  var tx2Serialized = zencashjs.transaction.serializeTx(tx2)
